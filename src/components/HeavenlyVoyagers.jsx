    ...
    <div className="min-h-screen bg-gray-50 pt-24 w-full overflow-x-hidden mt-[-12rem] md:mt-[-5rem]">
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Dedicated to spreading the gospel through evangelism, missions, Bible studies...",
            foundingDate: "2014",
            parentOrganization: {
              "@type": "Organization",
      ...
      <section className="relative bg-purple-900 text-white py-20 px-6 overflow-hidden">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-purple-800/50 backdrop-blur-md px-4 py-1.5 rounded-full text-purple-200 text-sm font-medium mb-6 border border-purple-700/50">
            <Plane size={16} className="text-purple-300" /> Est. 2014 • Western
            Kenya Conference
          </div>
          ...
          <p className="text-lg md:text-xl text-purple-100 leading-relaxed max-w-2xl mx-auto">
            Journeying together in faith. A fellowship-driven ministry dedicated
            to spreading the gospel and touching lives through missions and
            service.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 -mt-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {/* Mission */}
          <div
            className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-purple-600 hover:-translate-y-1 transition-transform duration-300"
            data-aos="fade-up"
            data-aos-delay="0"
          >
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex gap-3">
                ...
                To proclaim the three angels’ message according to Rev. 14:6-11
                (the present truth).
              </li>
              <li className="flex gap-3">
                <span className="text-purple-500 font-bold">•</span>
          ...
          {/* Vision */}
          <div
            className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-purple-400 hover:-translate-y-1 transition-transform duration-300"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <div className="w-12 h-12 bg-purple-50 rounded-xl flex items-center justify-center mb-6 text-purple-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
              ...
              <div className="relative border-l-2 border-purple-100 pl-8 ml-2 space-y-10">
                <div className="relative">
                  ...
                  <p className="text-gray-600 mt-2">
                    Began under the Western Kenya Conference Students
                    Association. Initially faced dormancy but the vision
                    remained alive.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mt-2">
                    Revived after a mission at Mwiruti Langas and officially
                    renamed <strong>Heavenly Voyagers Ministry</strong>.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-600 mt-2">
                    Expanded into <strong>Student</strong> and{" "}
                    <strong>Associate Chapters</strong>. Despite COVID-19
                    interruptions in 2020, we resumed full operations in 2021.
                  </p>
                </div>
              </div>
            </section>
            ...
            >
              ...
              <p className="text-gray-500 mb-6 text-sm">
                We have been privileged to serve in various locations across
                Kenya:
              </p>
          ...
          <div className="space-y-8">
            {/* Programs Card */}
            <section
              className="bg-purple-50 p-8 rounded-2xl sticky top-24"
              data-aos="fade-left"
            >
              <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={index}
                    className="px-3 py-1.5 bg-white text-purple-800 text-sm font-medium rounded-md shadow-sm border border-purple-100"
                  >
                    {program}
                  </span>
                ))}
              ...
              <div className="mt-8 pt-8 border-t border-purple-200">
                ...
                <p className="text-sm text-purple-700/80">
                  We meet regularly for fellowship, prayer, and mission
                  planning. Check church announcements for times.
                </p>
              </div>
            </section>
          </div>
        ...
        {/* Action Buttons */}
        <div
          className="mt-16 flex flex-col sm:flex-row justify-center gap-4 border-t border-gray-200 pt-10"
          data-aos="fade-up"
        >
          <Link
            to="/ministries"
          ...
          >
            Join Heavenly Voyagers{" "}
            <Plane size={18} className="text-purple-300" />
          </Link>
        </div>
      </div>
    </div>
